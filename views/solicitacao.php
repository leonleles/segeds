            ...
            <form id="formulario">
                ...
                <fieldset>
                    ...
                    <div class="form-group" id="agendamento">
                        ...
                        <input type="date" required value="<?= $solicitacao['data'] ?>" class="form-control col-4">
                        <input type="time" required value="<?= $solicitacao['hora'] ?>" class="form-control col-3">
                    </div>

                    <div class="form-group" id="previsao">
                        <label>Previsão de término:</label>
                        <input type="date" required value="<?= $solicitacao['data_previsao'] ?>" class="form-control col-4">
                        <input type="time" required value="<?= $solicitacao['hora_previsao'] ?>" class="form-control col-3">
                    </div>
                ...
                <button type="submit" style="margin-top: 30px;" class="btn btn-success save-solicitacao"
                        id="save-solicitacao">
                    <i
